...
// * <p>Create Time: 2022/7/29 18:04</p>
// * <p>Use the IntelliJ IDEA</p>
// * <p>Location: EasyTech/com.rycb.etech.block.tileentity/TileEntityMaterialPresser.java</p>
// * <h1><center>TileEntityMaterialPresser</center></h1>
// */
//public class TileEntityMaterialPresser extends TileEntity implements ITickable {
...
//    public static boolean isBurning(TileEntityMaterialPresser tile) {
...
//        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.material_press");
//    }
//
//    @Override
...
//        this.makeTime = compound.getInteger("MakeTime");
...
//        compound.setInteger("MakeTime", (short) this.makeTime);
...
//                    ++this.makeTime;
//
//                    if (this.makeTime == this.totalCookTime) {
//                        this.makeTime = 0;
...
//                    this.makeTime = 0;
//                }
//            } else if (!this.isBurning() && this.makeTime > 0) {
//                this.makeTime = MathHelper.clamp(this.makeTime - 2, 0, this.totalCookTime);
//            }
//
//            if (flag != this.isBurning()) {
//                flag1 = true;
//                BlockMaterialPresser.setState(this.isBurning(), this.world, this.pos);
//            }
//        }
//
//        if (flag1) {
...
//            return false;
//        } else {
//            ItemStack result = MaterialPresserRecipes.getInstance().getSinteringResult((ItemStack) this.handler.getStackInSlot(0), (ItemStack) this.handler.getStackInSlot(1));
//
//            if (result.isEmpty()) {
//                return false;
//            } else {
...
//        if (this.canSmelt()) {
//            ItemStack[] itemstack = new ItemStack[]{handler.getStackInSlot(0), handler.getStackInSlot(1)};
//            ItemStack itemstack1 = MaterialPresserRecipes.getInstance().getSinteringResult((ItemStack) this.handler.getStackInSlot(0), (ItemStack) this.handler.getStackInSlot(1));
